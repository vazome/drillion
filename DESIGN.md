...
A single-user, local web app for practising Python. A catalogue of 298 short tasks, 267 in Python,
11 Kubernetes manifests, 10 Helm charts and 10 Dockerfiles, each with a spec, a code editor, and a test that grades the code on fresh random data.
...
filter the screen cannot display is a screen that says "0 of 298" with no way to explain itself.
