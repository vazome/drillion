...
Longer: drillion is a local web app with 298 short tasks, 267 in Python, 11 Kubernetes
...
298 tasks. So it is worth saying plainly what that costs you.
...
MIT. See [LICENSE](LICENSE). 89 of the 298 tasks adapt a problem from Exercism's Python track
