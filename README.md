...
One consequence worth stating plainly: 201 tasks ship as executable Python, and `task.py`
...
201 tasks. So it is worth saying plainly what that costs you.
...
MIT. See [LICENSE](LICENSE). 89 of the 201 tasks adapt a problem from Exercism's Python track
