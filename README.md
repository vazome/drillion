...
Longer: drillion is a local web app with 323 short tasks, 267 in Python, 26 Kubernetes
manifests, 15 Helm charts and 15 Dockerfiles, each tagged with the
...
323 tasks. So it is worth saying plainly what that costs you.
...
MIT. See [LICENSE](LICENSE). 89 of the 323 tasks adapt a problem from Exercism's Python track
