...
| Low | The committed diff fails whitespace validation. | `git diff --check origin/main...HEAD` reports trailing whitespace in `docs/pocs/manifest-ui/report.md` and the config-authoring design, plus blank lines at EOF in the design. |
