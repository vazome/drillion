...
## Why
You run the servers for a company. Every month finance asks
...
## You get
`rows` — a list of pairs like [("api", 1234.5), ("db", 7.25)].
The test creates it and hands it to you; you never build it yourself.

## You return
one string with one line per pair: the name on the left, the
