...
## Why
You keep a list of the last few health-check readings for a server,
...
## You get
`xs` — a list of numbers like [10, 11, 12, 13, 14, 15], always at
least 5 long. The test creates it and hands it to you; you never build it
yourself.

## You return
a dict with five keys ("trim", "odds", "rev", "inner",
