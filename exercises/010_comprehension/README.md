...
## Why
After a compliance quiz, HR sends you a list of people with their
...
## You get
`records` — a list of two-item lists like [["ana", 80], ["bo",
12]], each holding a name and a score. The test creates it and hands it
to you; you never build it yourself.

## You return
a list of uppercase names, only those whose score is 50 or
