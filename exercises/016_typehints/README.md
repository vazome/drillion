...
## Why
You inherit a library of infrastructure functions written by
...
## You return
a triple (params, nullable, ret): a dict of input names to
...
- https://realpython.com/python-dicts/  — same, longer; 'Building a Dictionary Incrementally' and 'Dictionary Methods' (.items(), .pop()) are the 70% of this task
