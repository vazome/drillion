...
## Why
A central log collector mixes messages from every host into one
...
## You get
`lines` — a list of log lines like "web-1 ERROR disk full": a
...
## You return
a dict mapping each host to the list of its messages, in the
order they appeared.
