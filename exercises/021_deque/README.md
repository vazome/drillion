...
## Why
An incident is in progress and the on-call engineer asks "what were
...
## You get
`lines` — a stream of log lines like "10:01 ERROR boom" that
...
## You return
a list of the last `n` lines containing "ERROR", oldest
