...
## Why
A classic interview question and a real production bug. A script
...
## You get
`cfg` — a dict with two keys, like {"servers": ["web-1",
"db-2"], "ports": [80, 443]}. The test creates it and hands it to you;
you never build it yourself.

## You return
a tuple of three dicts (cfg, shallow, deep) showing what
