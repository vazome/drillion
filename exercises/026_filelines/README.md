...
## Why
The overnight backup job failed. The log file it wrote is huge, far
...
## You get
`path` — a string with the location of a log file on disk, like
...
## You return
a list of strings — the message part of every ERROR line, in
