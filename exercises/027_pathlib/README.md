...
## Why
A company keeps one folder per service on a shared server, each
...
## You get
`root` — a string with the path to the top folder, like
...
## You return
a dict with three keys: "logs" (sorted list of log file
