...
## Why
A colleague pastes a list of service names into a ticket, separated
...
## You get
`line` — one string of comma-separated names with messy
spacing, like " api, db ,cache ". The test creates it and hands it to
you; you never build it yourself.

## You return
one string with the names trimmed and joined by " | ", like
"api | db | cache".
