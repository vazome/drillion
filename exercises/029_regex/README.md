...
## Why
An application writes its log as free text, one line per event,
...
## You get
`text` — one big multi-line string. Each real event line looks
...
## You return
a list of dicts, one per event line in order, each with
