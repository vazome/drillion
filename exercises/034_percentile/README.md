...
## Hints
### Hint 1
Percentile questions are really sorting questions. p95 means: line the values up ascending and point at the one 95 percent of the way along. The whole exercise is the off-by-one — ranks count from 1, list indexes from 0.
### Hint 2
