...
## Why
You run a nightly job that pushes metrics to a monitoring vendor's
...
## You get
`call` — a function that takes no arguments. Calling it either
...
## You return
whatever `call()` returned the first time it worked. If every
