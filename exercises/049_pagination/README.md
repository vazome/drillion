...
## Why
An ops engineer needs a list of every pod in a cluster for a
...
## You get
`fetch_page` — a function that takes a cursor (None for the
...
## You return
one flat list of every item from every batch, in the order
