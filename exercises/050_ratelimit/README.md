...
## Why
A cleanup script calls a vendor's API hundreds of times in a row.
...
## You get
`request` — a function with no arguments; each call makes one
...
## You return
the "body" part of the first answer with status 200. If an
