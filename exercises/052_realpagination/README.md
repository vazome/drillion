...
## Why
A manager wants every open issue in the team's repo on a
...
## You get
`first_url` — a string: the web address of the first page,
...
## You return
one flat list of every issue dict from every page, in the
