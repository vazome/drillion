...
## Why
A status page must fetch the state of a dozen services before it
...
## You get
nothing — you build the thing from scratch. Your solve()
...
## You return
the helper function itself (an async function that takes a
