---
title: boto3 task — find unattached EBS volumes
minutes: 25
prereqs: [68]
tags: [cloud, boto3]
practices: [9, 28, 68]
---
# boto3 task — find unattached EBS volumes
...
## Why
The cloud bill keeps growing. One common cause is disk volumes
...
## You get
`ec2` — an AWS EC2 client object, the thing you call to ask
...
## You return
a pair (tuple): a sorted list of (volume_id, size_in_gb)
