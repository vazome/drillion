---
title: 'DRILL: recursive diff of two nested configs'
minutes: 30
prereqs: [18]
tags: [whole-task]
practices: [30, 18, 25]
---
# DRILL: recursive diff of two nested configs
...
## Why
The staging environment works and production does not. Both were
...
## You get
`old` — a nested dictionary (a dictionary whose values can
...
## You return
one dictionary with three keys: "added", "removed" and
