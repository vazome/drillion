---
title: 'DRILL: poll until healthy, back off, exit code'
minutes: 30
prereqs: [46]
tags: [whole-task]
practices: [46, 45, 39]
---
# DRILL: poll until healthy, back off, exit code
...
## Why
A deploy pipeline has just pushed a new version of a service.
...
## You get
`check` — a function you call with no arguments; it answers "is
...
## You return
a dictionary with three keys: "exit_code" (0 for healthy, 1
