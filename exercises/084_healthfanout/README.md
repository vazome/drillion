---
title: 'DRILL: health-check a URL list in parallel'
minutes: 25
prereqs: [43]
tags: [whole-task]
practices: [43, 46, 54]
---
# DRILL: health-check a URL list in parallel
...
## Why
A company runs dozens of small services, each with a health
...
## You get
`urls` — a list of web addresses as strings, like
...
## You return
a dictionary mapping each address to one word: "healthy"
