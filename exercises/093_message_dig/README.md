...
## Why
A company pipeline sends a question to an AI chat service and
...
## You get
`payload` — a nested dictionary (dictionaries and lists inside
...
## You return
a dictionary with exactly four keys: "text" (the answer
