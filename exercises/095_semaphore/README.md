...
## Why
A connection pool is exactly this idea: N slots, and the (N+1)th
...
## Read first
- https://superfastpython.com/asyncio-semaphore/  — what a semaphore is, with runnable examples; read up to 'Example of Using an Asyncio Semaphore'
