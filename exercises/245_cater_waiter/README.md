...
minutes: 14
prereqs: [200, 221, 227, 233, 236]
tags: [exercism, sets, data-structures]
...
> [!NOTE]
> Exercism asks for all seven functions in one `sets.py`. Here the exercise is split in three: **this drill covers tasks 1, 5 and 6** — the ones that are pure set arithmetic and need no reference data. Tasks 2 and 4 are drill `246_cater_waiter`; tasks 3 and 7 are drill `247_cater_waiter`.
