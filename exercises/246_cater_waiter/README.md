...
minutes: 14
prereqs: [200, 221, 227, 233, 236, 245]
...
> [!NOTE]
> Exercism asks for all seven functions in one `sets.py`. Here the exercise is split in three: **this drill covers tasks 2 and 4** — the two that check a recipe against a reference list. Tasks 1, 5 and 6 are drill `245_cater_waiter`; tasks 3 and 7 are drill `247_cater_waiter`.
