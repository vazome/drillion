...
minutes: 15
prereqs: [200, 221, 227, 233, 236, 246]
...
> [!NOTE]
> Exercism asks for all seven functions in one `sets.py`. Here the exercise is split in three: **this drill covers tasks 3 and 7** — the two comparison-shaped ones. Tasks 1, 5 and 6 are drill `245_cater_waiter`; tasks 2 and 4 are drill `246_cater_waiter`.
>
