...
minutes: 15
prereqs: [200, 203, 206, 212, 215, 221, 227, 233, 236, 245]
...
> [!NOTE]
> Exercism asks for the class plus a standalone `new_aliens_collection()` function in one `classes.py`. Here the exercise is split in two: **this drill covers tasks 1–6**, the class itself. Task 7, the function that builds a list of aliens from a list of positions, is drill `249_ellens_alien_game`.
...
## Rules
- this drill implements **Exercism tasks 1 to 6 only** — `new_aliens_collection` belongs to drill `249_ellens_alien_game`
...
- [DigitalOcean: Class and instance variables](https://www.digitalocean.com/community/tutorials/understanding-class-and-instance-variables-in-python-3) — the exact distinction this drill grades
