...
- [str.isupper()](https://docs.python.org/3/library/stdtypes.html#str.isupper) — `isupper()`, and the detail that decides this exercise: it is `False` for text containing no letters at all
