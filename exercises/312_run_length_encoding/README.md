---
title: run-length-encoding — compress runs, and put them back
minutes: 15
prereqs: [200, 203, 206, 209, 215, 218, 221, 224, 227]
tags: [exercism, iteration, regular-expressions, data-structures]
source: exercism/python practice/run-length-encoding (MIT, adapted)
---
# run-length-encoding — compress runs, and put them back
