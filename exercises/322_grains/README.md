...
## Hints
### Hint 1
Write the first four squares down: 1, 2, 4, 8. Then write the powers of two next to them: 2⁰, 2¹, 2², 2³. The offset between "square number" and "exponent" is the entire arithmetic part of this drill, and getting it wrong by one is the classic way to fail square 1. Do the validation first, though — a function that rejects bad input before computing anything is easier to read than one that computes and then apologises.
