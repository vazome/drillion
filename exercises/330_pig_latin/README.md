---
title: pig-latin — translate English into a children's code
minutes: 15
prereqs: [200, 203, 209]
tags: [exercism, conditionals, core]
source: exercism/python practice/pig-latin (MIT, adapted)
---
# pig-latin — translate English into a children's code
...
The rules are written in the order the specification lists them, each one returns immediately, and the fallback sits at the bottom. Reordering those three `if`s changes the output — which is exactly the trap in this exercise.
