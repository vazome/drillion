---
title: sublist — say how two lists relate to each other
minutes: 15
prereqs: [200, 203, 209, 212, 221]
tags: [exercism, comparisons, core]
source: exercism/python practice/sublist (MIT, adapted)
---
# sublist — say how two lists relate to each other
...
Four constants are already defined at the top of `drill.py` and marked *do not edit* — `SUBLIST`, `SUPERLIST`, `EQUAL` and `UNEQUAL`. Use them by name.
