---
title: prime-factors — break a number into the primes it is built from
minutes: 15
prereqs: [200, 206, 209, 221, 224, 227]
tags: [exercism, core]
source: exercism/python practice/prime-factors (MIT, adapted)
---
# prime-factors — break a number into the primes it is built from
...
"Keep applying the same divisor until it no longer fits, then hand on what is left" is the whole inner loop. The exercise wraps this in an outer loop that tries 2, then 3, then 4, and so on — and each pass hands the shrunken number to the next.
