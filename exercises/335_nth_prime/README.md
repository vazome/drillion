...
`pages()` never ends and never needs to; `islice` stops asking after the fourth record, so page 3 is never fetched. Substitute "is this number prime?" for "is this record interesting?" and you have the exercise.
