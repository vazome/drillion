---
title: grade-school — a roster that stays sorted by grade, then by name
minutes: 20
prereqs: [200, 221, 224, 236, 248]
tags: [exercism, collections, dict-methods, data-structures]
source: exercism/python practice/grade-school (MIT, adapted)
---
# grade-school — a roster that stays sorted by grade, then by name
