---
title: robot-simulator — a robot that turns and advances on an infinite grid
minutes: 20
prereqs: [200, 206, 209, 221, 227, 233, 236, 248]
tags: [exercism, class-customization, decorators, dict-methods, core]
source: exercism/python practice/robot-simulator (MIT, adapted)
---
# robot-simulator — a robot that turns and advances on an infinite grid
...
## You get
Nothing to start — you return a **class**. The four compass names are **already written for you** at the top of `drill.py`, marked `# given — do not edit`:
