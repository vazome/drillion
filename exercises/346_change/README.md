---
title: change — hand back the fewest coins that add up
minutes: 25
prereqs: [200, 203, 206, 209, 221, 224, 227]
tags: [exercism, loops, core]
source: exercism/python practice/change (MIT, adapted)
---
# change — hand back the fewest coins that add up
...
## Hints
### Hint 1
The greedy instinct is the trap; this exercise exists because of it. So do not ask "which coin do I take first?". Ask a smaller question instead: *if I already knew the best answer for every amount below the target, how would I get the target's answer in one step?*
