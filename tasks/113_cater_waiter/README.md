...
> [!NOTE]
> Exercism asks for all seven functions in one `sets.py`. Here the task is split in three: **this task covers tasks 2 and 4** — the two that check a recipe against a reference list. Tasks 1, 5 and 6 are task `112_cater_waiter`; tasks 3 and 7 are task `114_cater_waiter`.
