...
> [!NOTE]
> Exercism asks for all seven functions in one `sets.py`. Here the task is split in three: **this task covers tasks 3 and 7** — the two comparison-shaped ones. Tasks 1, 5 and 6 are task `245_cater_waiter`; tasks 2 and 4 are task `246_cater_waiter`.
>
