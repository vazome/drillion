...
> [!NOTE]
> Exercism asks for all six functions in one `none.py`. Here the task is split in three: **this task covers tasks 3 and 4** — reading a chart. Tasks 1 and 2 are task `257_restaurant_rozalynn`; tasks 5 and 6 are task `259_restaurant_rozalynn`.
