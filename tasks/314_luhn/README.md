---
title: luhn — the checksum that catches a mistyped card number
minutes: 15
prereqs: [200, 203, 206, 209, 215, 218, 221, 224, 227, 248]
tags: [exercism, classes, core]
source: exercism/python practice/luhn (MIT, adapted)
---
# luhn — the checksum that catches a mistyped card number
