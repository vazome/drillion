...
tasks/009_fstrings/task.py:24:
_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _

>       raise NotImplementedError
E       NotImplementedError

tasks/009_fstrings/task.py:2: NotImplementedError
=========================== short test summary info ============================
FAILED tasks/009_fstrings/task.py::test_solve - NotImplementedError
"""
...
def test_summarise_maps_the_region_to_editor_lines():
    ...
    assert "tasks/009_fstrings/task.py:24:" in out["output"]  # the test frame stays put


def test_summarise_falls_back_to_the_failed_line_and_caps_the_headline():
    only_failed = "FAILED tasks/009_fstrings/task.py::test_solve - boom\n"
...
def test_selfcheck_solves_each_task_with_its_own_reference(
    ...
    for slug in ("009_fstrings", "008_slicing"):
...
WINDOWS_OUT = (
    "..\\tasks\\009_fstrings\\task.py:9: AssertionError\n"
    "=========================== short test summary info ===========================\n"
    "FAILED ..\\tasks\\009_fstrings\\task.py::test_solve - assert 1 == 2\n"
)
...
def test_a_windows_path_reaches_the_panel_the_same_way_a_posix_one_does():
    ...
    assert "../tasks/009_fstrings/task.py:9" in text
    assert "\\" not in text
...
def test_a_failed_line_names_the_task_folder_and_nothing_else(sep):
    ...
    line = f"FAILED ..{sep}tasks{sep}009_fstrings{sep}_selfcheck.py::test_solve - boom"
    collected = f"ERROR ..{sep}tasks{sep}008_slicing{sep}_selfcheck.py"
